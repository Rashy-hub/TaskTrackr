...
import { topicIdValidator } from '../validators/topic-validators.js'

const todoRouter = express.Router()

// Remplacement de authenticateToken par Passport.js
todoRouter.get('/todos/:id', passport.authenticate('jwt', { session: false }), paramsValidation(topicIdValidator), todoController.getTodos)
